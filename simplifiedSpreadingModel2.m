...
%function simplifiedSpreadingModel(numHosts,numSteps,...
%    infectionStep,freezeStep,criteria,...
...
%   - randomSeed2: randomSeed for the infection dynamics
...
%   - node.txt:    All Centrality Measures, Plus Infection Data;
%   - network.txt: All Centrality Measures, Plus Infection Data; 
...
%     Fefferman & Ng or Matlab (2017). At some point we may want       %
%     to consider a different type of structure.                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
